function IceCloud(x, y,size,speed,angle,range,targetArray)
{
...
IceCloud.prototype = Object.create(Projectile.prototype);



IceCloud.prototype.update = function() {
	if(this.life==this.maxLife)
		this.explode();
	this.life--;
};

IceCloud.prototype.draw = function() {
	ctx.beginPath();
