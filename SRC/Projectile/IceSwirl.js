function IceSwirl(x, y,size,speed,angle,range,targetArray,caster)
{
	Projectile.call(this,x,y,size,speed,angle,range);
	this.targetArray = targetArray;
	this.life = 100;
	this.sps = ProjectileSpriteSheet;
	this.spsCoord = [2*256,256*1,256,256];
...
IceSwirl.prototype = Object.create(Projectile.prototype);

IceSwirl.prototype.draw = function() {
	ctx.beginPath();
	ctx.save();
...
IceSwirl.prototype.update = function() {
	if(this.life == 100)
	{
	this.caster.y =  -1000;
...
IceSwirl.prototype.nearCheck = function(){
...
IceSwirl.prototype.cut= function(){
